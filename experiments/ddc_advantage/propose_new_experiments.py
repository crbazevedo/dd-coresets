#!/usr/bin/env python3
"""
Propose new experiment categories based on DDC strengths.

Considering DDC strengths:
- k small (k << n)
- Well-defined clusters (4-8 clusters)
- Multimodal distributions
- Guaranteed spatial coverage

Propose datasets/distributions that would benefit:
"""
...
def generate_proposal():
    """Generate proposal for new experiment categories."""
...
def main():
    ...
    output_path = Path(__file__).parent.parent.parent / "docs" / "NEW_EXPERIMENTS_PROPOSAL.md"
    
    with open(output_path, 'w') as f:
        f.write(proposal)
    
    print("=" * 70)
    print("PROPOSAL FOR NEW EXPERIMENTS GENERATED")
    print("=" * 70)

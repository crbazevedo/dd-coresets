...
def create_notebook():
    ...
    cells.append({
        ...
        "source": [
            ...
            "    \n",
            "    # Adjust parameters for smaller classes to ensure good coverage\n",
            "    # Use more diversity (lower alpha) for better coverage\n",
            ...
            "        k=k_class,\n",
            "        n0=n0_class,\n",
            "        alpha=alpha_class,  # Slightly lower alpha for better diversity\n",
            "        m_neighbors=min(32, len(X_class) // 10),  # Adjust neighbors for small classes\n",
            "        gamma=1.0,\n",
            "        refine_iters=2,  # More refinement for better quality\n",
